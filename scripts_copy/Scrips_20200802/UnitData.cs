...
namespace PCRCaculator
{
    ...
    public class SkillAction
    {
        ...
        public readonly int target_assigment;//对方-1，己方-2，所有-3，未知-0 OTHER_SIDE=1,OWNER_SIDE=2,ALL=3
        public readonly int target_area;//FRONT=1,FRONT_AND_BACK=2,ALL=3
        public readonly int target_range;//-1到4320以及9999
        public readonly int target_type;//排序优先度
        ...
        public string GetDetail(int skilllevel, float atk)
        {
            ...
            switch (type)
            {
                ...
                case 2://(MOVE)
                    ...
                    "<color=#002DFF>(未知技能片段[MOVE]";
                    break;
                case 3://(KNOCK)击退类技能
                    detailstr = description +
                    "<color=#002DFF>(未知技能片段[KNOCK]";
                    break;
                ...
                case 8://(CHANGE_SPEED)加速、敌方行动不能
                    switch (details[0])
                    {
                        case 1://敌方行动速度降低
                            detailstr = description +
                            "<color=#002DFF>(降低倍率：" + values[0] + "持续时间：" + values[2];
                            break;
                        case 2://己方行动速度提升
                            detailstr = description +
                            "<color=#002DFF>(提升倍率：" + values[0] + "持续时间：" + values[2];
                            break;
                        case 3://麻痹
                        case 4://冻结
                        case 5://束缚
                        ...
                        case 7://敌方行动不能
                            detailstr = description +
                            "<color=#002DFF>(成功率等级：" + skilllevel + "持续时间：" + values[2];
                            break;
                        default:
                            detailstr = description +
                ...
                case 10://(BUFF_DEBUFF)
                    ...
                    "<color=#002DFF>(种类：" + ((Battle.BuffParamKind)Mathf.FloorToInt(details[0]/10)).GetDescription() +"," + values[1] + "+" + values[2] + "✕技能等级,持续时间：" + values[3] + values[4]*skilllevel;
                    break;
                case 11://(CHARM)混乱/诱惑
                case 12://(BLIND)黑暗
                    detailstr = description +
                ...
                case 16://(CHARGE_ENERGY)TP回复/流失
                    detailstr = string.Format(description, values[0] + values[1] * skilllevel) +
                    "<color=#002DFF>(" + values[0] + "+" + values[1] + "✕技能等级";
                    break;
    ...
    public class EquipmentData
    {
        ...
        public EquipmentData(string data)
        {
            ...
            this.data = new BaseData(data0[3]);
            data_rate = new BaseData(data0[4]);
        }
        /// <summary>
        /// 获取装备的最大强化等级
        /// </summary>
        ...
        public override string ToString()
        {
            string[] str = new string[5] { equipment_id + "", equipment_name, promotion_level + "", data.ToString(), data_rate.ToString() };
